...
const AddSkillForm = () => {
  ...
  return (
    ...
    <div className="mb-4">
      <label htmlFor="estimate" className="block text-gray-700 font-semibold mb-2">
    ...
    <button
      type="submit"
      className="w-full bg-indigo-500 text-white py-3 rounded-md hover:bg-indigo-600 transition duration-300 ease-in-out font-semibold"
    >
      Add Skill
    </button>
  </form>
